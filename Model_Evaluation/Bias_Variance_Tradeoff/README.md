...
The bias-variance tradeoff is the fundamental tension in ML between underfitting (high bias) and overfitting (high variance). It explains why models fail and guides model selection.

**Simple Analogy**: Like adjusting a camera focus: Too simple (high bias) and everything is blurry; too complex (high variance) and it focuses on dust particles instead of the subject.

## 2. Why do we need it?

Understanding this tradeoff helps you diagnose model problems and choose appropriate complexity levels. It's the key to building models that generalize well.
