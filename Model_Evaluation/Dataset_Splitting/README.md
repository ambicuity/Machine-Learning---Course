# Dataset Splitting (Train/Validation/Test Sets)

## 1. What is this concept?

Dataset splitting is the practice of dividing your data into separate subsets for training, validation, and testing. This ensures your model's performance is evaluated on unseen data, not memorized training examples.

**Simple Analogy**: Like studying for an exam with practice problems (train), taking practice tests (validation), and the final exam (test). You wouldn't use the same questions on the final that you practiced with!

## 2. Why do we need it?

Without proper splitting, you can't know if your model truly learned patterns or just memorized training data (overfitting). It's essential for honest performance evaluation.
