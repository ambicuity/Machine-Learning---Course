...
GDA is a probabilistic classification algorithm that models each class as a Gaussian (normal) distribution. It assumes features follow a multivariate Gaussian distribution for each class and uses Bayes' theorem to classify new examples.
