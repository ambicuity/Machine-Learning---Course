...
Model-Based RL learns a model of the environment (transition and reward functions), then uses it for planning. It's more sample-efficient than model-free methods but requires accurate environment models.
