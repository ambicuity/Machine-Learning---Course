...
Policy Iteration alternates between policy evaluation (computing value of current policy) and policy improvement (making policy greedy with respect to values). Often converges faster than value iteration.
