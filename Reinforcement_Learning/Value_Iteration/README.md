...
Value Iteration is a dynamic programming algorithm for finding optimal policies in MDPs. It iteratively updates value estimates for each state until convergence, then derives the optimal policy.
