...
Kernels are functions that implicitly map data to higher-dimensional spaces where it becomes linearly separable. They enable SVMs and other algorithms to find non-linear decision boundaries efficiently.
...
- Kernel trick avoids explicit mapping
