...
SVMs find the optimal hyperplane that maximally separates classes. They focus on the 'support vectors' (points near the decision boundary) and can handle non-linear boundaries using kernels.
