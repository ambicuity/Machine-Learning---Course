...
Boosting combines many weak learners (usually shallow trees) sequentially, where each new model focuses on correcting mistakes of previous models. It's one of the most powerful ML techniques.
