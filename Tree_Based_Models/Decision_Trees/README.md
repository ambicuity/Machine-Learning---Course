...
Decision Trees learn a tree structure that makes predictions by asking a sequence of questions about features. They recursively split data to create regions with pure or mostly pure class labels.
