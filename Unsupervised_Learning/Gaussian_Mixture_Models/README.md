...
GMMs model data as a mixture of multiple Gaussian distributions. Unlike K-Means, GMMs provide soft assignments (probabilities) and can capture clusters of different shapes and sizes.
