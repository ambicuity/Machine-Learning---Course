...
K-Means is an unsupervised learning algorithm that groups data into K clusters. It iteratively assigns points to nearest cluster centers and updates centers to minimize within-cluster variance.
